...
function Hero() {
  return (
    <section  id="hero" className="relative overflow-hidden min-h-screen flex items-center bg-gradient-to-br from-gray-950 via-gray-900 to-black pt-20 pb-10 lg:pt-20 lg:pb-0">
      {/* Background Glow */}
